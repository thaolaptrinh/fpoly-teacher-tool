              ...
              <form id="kt_modal_update_form" class="form" action="#">
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_header" data-kt-scroll-wrappers="#kt_modal_update_scroll" data-kt-scroll-offset="300px">
                  ...
                  <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <input type="text" name="email_update" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="">
                  </div>

                  <div class="fv-row mb-7 fv-plugins-icon-container">
                    <label class="required fw-semibold fs-6 mb-2">Access</label>
                    <input type="number" min="1" name="access_update" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="">
                  </div>
              ...
              <form id="kt_modal_add_form" class="form" action="#">
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_header" data-kt-scroll-wrappers="#kt_modal_add_scroll" data-kt-scroll-offset="300px">
                  ...
                  <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <i class="fas fa-question-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Value: 999 (toàn quyền)"></i>

                    <input type="number" min="1" name="access" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="">
                  </div>
    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_list">
      <thead>
        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
          ...
          <th class="min-w-125px">Quyền hạn</th>
        ...
        if (!empty($this->data['accounts'])) {
          ...
          foreach ($accounts as $item) {
            ...
            <tr>
              ...
              <td>
                <div class="badge badge-light-<?= $access == 999 ? 'success' : 'primary' ?> fw-bold">
                  <?= $access == 999 ? 'Toàn quyền' : 'Thường' ?>
                </div>
              ...
              <td class="text-end">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                  <div class="menu-item px-3">
                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#kt_modal_update" class="menu-link px-3" onclick="initUpdateDetail(<?= $id ?>);">Edit</a>
                  </div>
                  <div class="menu-item px-3">
