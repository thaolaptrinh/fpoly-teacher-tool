      ...
      <div class="card-body py-9">
        <div class="row gx-9 h-100">
          <div class="col-sm-6 mb-10 mb-sm-0">
            <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100" style="background-size: 100% 100%;background-image:url(<?= BASE_URL('assets/media/img-33.jpg') ?>)"></div>
          </div>
          <div class="col-sm-6">
            <div class="d-flex flex-column h-100">
              ...
              <div class="d-flex flex-stack mt-auto bd-highlight">
                ...
                <a href="<?= ADMIN_URL('giao-vien') ?>" class="text-primary opacity-75-hover fs-6 fw-semibold">Quản lý giáo viên
        ...
        <div class="row align-items-center h-100">
          <div class="col-7 ps-xl-13">
            ...
            <div class="d-flex flex-column flex-sm-row d-grid gap-2">
              <a href="<?= ADMIN_URL('') ?>" target="_blank" class="btn btn-primary flex-shrink-0" style="background: rgba(255, 255, 255, 0.2)">My App</a>
            </div>
          </div>
          <div class="col-5 pt-10">
            <div class="bgi-no-repeat bgi-size-contain bgi-position-x-end h-225px" style="background-image:url('<?= BASE_URL('assets/media/svg/5.svg') ?>')"></div>
          </div>
        </div>
      </div>
    </div>
