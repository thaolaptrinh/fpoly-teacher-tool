    ...
    <div class="app-container container-xxl d-flex align-items-stretch justify-content-between">
      <div class="d-flex flex-grow-1 flex-lg-grow-0">
        <div class="d-flex align-items-center me-7" id="kt_app_header_logo_wrapper">
          <button class="d-lg-none btn btn-icon btn-color-white bg-hover-white bg-hover-opacity-10 w-35px h-35px ms-n2 me-2" id="kt_app_header_menu_toggle">
          ...
          <a href="" class="d-flex align-items-center">
            <img alt="Logo" src="<?= BASE_URL('assets/media/logos/logo.png') ?>" class="h-35px" />
          </a>
        </div>
      ...
      <div class="app-navbar flex-shrink-0">
        ...
        <div class="app-navbar-item ms-3" id="kt_header_user_menu_toggle">
          ...
          <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            <img src="https://ui-avatars.com/api/?name=<?= $DB->getInfoTeacher('email') ?>" alt="user" />
          ...
          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
            ...
            <div class="menu-item px-3">
              <div class="menu-content d-flex align-items-center px-3">
                ...
                <div class="d-flex flex-column">
                  ...
                  <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?= $DB->getInfoTeacher('email') ?></a>
            ...
            <div class="menu-item px-5">
              <a href="<?= BASE_URL('auth/logout') ?>" class="menu-link px-5">Đăng xuất</a>
            </div>
        ...
        <div class="app-navbar-item ms-3">
          ...
          <a href="#" class="btn btn-icon btn-icon-white btn-active-color-primary btn-custom w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
        ...
        <div class="app-navbar-item ms-3">
          <a href="<?= BASE_URL('auth/logout') ?>" class="btn btn-icon btn-icon-white btn-active-color-primary btn-custom w-35px h-35px w-md-40px h-md-40px">
