...
if ($type == 'teacher') { ?>
  ...
  <script src="<?= BASE_URL('assets/js/custom/utilities/modals/donate.js') ?>"></script>
...
<?php } elseif ($page_target == 'index') { ?>
  <script src="<?= BASE_URL('assets/admin/js/custom/app/calendar/table.js') ?>"></script>
<?php } else if ($page_target == 'admin/index') { ?>
  <script src="<?= BASE_URL('assets/admin/js/index.js') ?>"></script>
<?php } elseif ($page_target == 'admin/teachers') { ?>
  <script src="<?= BASE_URL('assets/admin/js/teacher/table.js') ?>"></script>

<?php } elseif ($page_target == 'admin/co_so') { ?>
