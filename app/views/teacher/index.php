        ...
        <div class="row g-5 g-lg-9">
          <div class="col-6">
            <div class="card card-shadow">
              <div class="card-body p-0">
                <a href="" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app" class="btn btn-active-color-primary p-9 text-start w-100">
                  ...
                  <div class="fw-bold fs-4 pt-8">Tạo bảng điểm</div>
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="card card-shadow">
              ...
              <div class="card-body p-0">
                ...
                <a href="https://www.facebook.com/thaotoiday" target="_blank" class="btn btn-active-color-primary p-9 text-start w-100">
                  ...
                  <div class="fw-bold fs-4 pt-8">Liên hệ quản trị</div>
                  <!--end::Desc-->
                </a>
                <!--end::Items-->
              </div>
    ...
    <div class="card card-flush border-0">
      <div class="card-header pt-7">
        ...
        <div class="card-toolbar">
          <form action="">
            <select name="hoc_ky" id="hoc_ky" onchange="this.form.submit();" class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Chọn học kỳ">
              <option></option>
              <?php
              if (isset($this->data['hoc_ky']) && !empty($this->data['hoc_ky'])) {
                $hoc_ky = $this->data['hoc_ky'];
                foreach ($hoc_ky as $row) { ?>
                  <option value="<?= $row['id_hocky'] ?>" <?= (isset($_GET['hoc_ky'])  && $_GET['hoc_ky'] == $row['id_hocky'])  ? 'selected="selected"' : false  ?>><?= $row['ten_hocky'] ?></option>
                <?php }
              } else { ?>
                ...
                foreach ($lich_day as $row) {
                  ...
                  <tr>
                    ...
                    <td class="ps-0 text-start">
                      <span class="text-gray-800 fw-bold fs-6 d-block"><?= $ma_mon ?> - <?= $ten_mon ?></span>
