			...
			<div class="d-flex flex-wrap align-items-center mb-10">
				...
				<div id="kt_signin_password_edit" class="flex-row-fluid d-none">
					<form id="kt_signin_change_password" class="form" novalidate="novalidate">
						...
						<div class="form-text mb-5">Mật khẩu mới gồm 8 ký tự trở lên bao gồm các chữ cái, số và ký tự đặc biệt.</div>
						<div class="d-flex">
							<button id="kt_password_submit" type="button" class="btn btn-primary me-2 px-6">Cập nhật</button>
			...
			<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
				...
				<div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
					<div class="mb-3 mb-md-0 fw-semibold">
						<h4 class="text-gray-900 fw-bold">Bảo mật tài khoản</h4>
						<div class="fs-6 text-gray-700 pe-7">
							Không chia sẻ thông tin đăng nhập cho bất cứ ai</div>
					</div>
