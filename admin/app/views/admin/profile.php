...
<div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
  <button id="kt_user_profile_aside_close" class="kt-app__aside-close"><i class="la la-close"></i></button>
        ...
        <div class="kt-widget kt-widget--user-profile-1">
          <div class="kt-widget__head">
            <div class="kt-widget__media">
              <img src=" <?= isset($picture) ? $picture : false ?>" alt="image">
            </div>
            <div class="kt-widget__content">
              <div class="kt-widget__section"><a href="#" class="kt-widget__username">
                  <?= isset($givenName) ? $givenName : false ?></a>
                <i class="flaticon2-correct kt-font-success">
                </i>
                </a> <span class="kt-widget__subtitle">
                  Quản trị
                </span>
              </div>
            </div>
          ...
          <div class="kt-widget__body">
            <div class="kt-widget__content">
              <div class="kt-widget__info"><span class="kt-widget__label">Email:
                ...
                </span> <a href="#" class="kt-widget__data">
                  <?= isset($email) ? $email : false ?></a>
              </div>
            </div>
                ...
                <div class="kt-section__body">
                  ...
                  <div class="form-group row"><label class="col-xl-3 col-lg-3 col-form-label">Họ và tên</label>
                    <div class="col-lg-9 col-xl-6">
                      <input type="text" value="<?= isset($givenName) ? $givenName : false ?>" readonly="readonly" class="form-control">
                    </div>
                  </div>

                  <div class="form-group row"><label class="col-xl-3 col-lg-3 col-form-label">Email</label>
                    <div class="col-lg-9 col-xl-6">
                      <input type="email" value="<?= isset($email) ? $email : false ?> " readonly" class="form-control">
                    </div>
                  </div>
                </div>
              </div>
